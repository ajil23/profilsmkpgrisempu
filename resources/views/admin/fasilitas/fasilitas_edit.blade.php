...
@section('admin')
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                <form method="POST" action="{{route('fasilitas.update', $editfasilitas->id)}}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col">
                          <label for="nama">Nama Fasilitas</label>
                          <input type="text" class="form-control" placeholder="Nama Fasilitas" name="nama" value="{{$editfasilitas->nama}}">
                        </div>
                        <div class="col">
